      ...
      <main id={styles.mainContent}>
        ...
        <div id='hostMenu' className={hostMenu}>
          ...
          <form id='hostGameOptionsMenu' className={styles.hostGameForm} onSubmit={function(e) { e.preventDefault() }}>
            ...
            <input type='button' id='resetToDefault' value='Reset to Default' className={['smallButton', styles.resetToDefault].join(' ')}></input>
            <button className={['isMain', styles.startGameBtn].join(' ')}>Start Game</button>
          </form>
        </div>
